...
/** Mixins */
/** Actually just a simple composition */
const Mixin = InnerComponent => class extends React.Component {
    ...
    render() {
        // Set everything as props for Inner component
...
const BaseBtn = (props) => <button onClick={props.update}>{props.txt} - {props.val}</button>
const BaseLabel = (props) => <label onMouseMove={props.update}>{props.txt} - {props.val}</label>
const ButtonMixed = Mixin(BaseBtn);
const LabelMixed = Mixin(BaseLabel);
